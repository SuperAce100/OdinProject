...
function toggleGridLines() {
    ...
    for(var i = 0; i < cells.length; i++) {
        if (gridEnabled) {
            ...
            let newWidth = (parseFloat(cells[i].style.width.substring(0, cells[i].style.width.length - 2)) + 2) + "px"
            console.log(cells[i].style.width.substring(0, cells[i].style.width.length - 2))
            cells[i].style.width = newWidth
            cells[i].style.height = newWidth
        } else {
            cells[i].style.border = "1px solid lightgrey"
            let newWidth = (parseFloat(cells[i].style.width.substring(0, cells[i].style.width.length - 2)) - 2) + "px"
            cells[i].style.width = newWidth
            cells[i].style.height = newWidth
        }
